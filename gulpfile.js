...
var paths= {
	...
	// isotop: './node_modules/isotope-layout/dist/',
}
...
// 		extensions: "js",
// 		hardFail: true,
// 		includePaths: [paths.bootstrap, paths.isotop, paths.jquery, paths.src.js]
// 	}).on('error', notify.onError(
// 	{
// 		message: "<%= error.message %>",
// 		title  : "JS Error!"
...
// 	});
gulp.task('js', function () {
    return gulp.src(paths.src.js_main)
   // .pipe(uglify()) не нужен пока(минимизатор)
   .pipe(gulp.dest(paths.dest.js));
});
